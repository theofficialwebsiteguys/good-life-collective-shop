/*
 * Public API Surface of shop-components
 */

export * from './lib/shop-components.service';
...
export * from './lib/components/recent-products-carousel/recent-products-carousel.component'
